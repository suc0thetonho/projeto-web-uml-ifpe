document.addEventListener('DOMContentLoaded', () => {
    const inputEmail = document.getElementById('input-email-erro');
    const inputCodigo = document.getElementById('input-codigo-erro');
    const btnVerificar = document.getElementById('btn-verificar-erro');
